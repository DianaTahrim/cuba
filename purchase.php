                    ...
                    <div class="card-header">
                    	<div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="card-title">Senarai Pembelian</h3>
                            </div>
                        
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 text-end">
                                <button type="button" name="add" id="addPurchase" class="btn btn-success bg-gradient rounded-0 btn-sm"><i class="far fa-plus-square"></i>Pembelian</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="action" id="action" class="btn btn-success btn-sm rounded-0" value="Add" form="purchaseForm"/>Tambah</button>
                            <button type="button" class="btn btn-default border btn-sm rounded-0" data-bs-dismiss="modal">Tutup</button>
                        </div>
                    </div>
            </div>
        </div>
